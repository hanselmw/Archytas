(ns archytas.util
  (:require [archytas.stream.spi :refer [read!]]
            #+clj 
...
(defn arduino-delay
  "takes a time value in milliseconds and sleeps the given time"
  [ms]
  (Thread/sleep ms))

(defn delay-microseconds
  "takes a time value in microseconds and sleeps the given time"
  [us]
