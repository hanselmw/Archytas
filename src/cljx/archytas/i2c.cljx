(ns archytas.i2c
  (:require [archytas.core :refer [send-message]]
            [archytas.util :refer [msb lsb bytes-to-int]]
            [archytas.stream.spi :refer [read!]]
            [archytas.messages :refer [SYSEX_START SYSEX_END
