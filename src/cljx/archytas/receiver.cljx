(ns archytas.receiver
  "Deprecated: use archytas.core/event-channel and archytas.core/release-event-channel directly
  for general events.  For analgo and digital events, use archytas.async's channel functions."
  (:require [archytas.core :refer [event-channel release-event-channel]]
            [archytas.async :refer [digital-event-chan analog-event-chan]]
            #+clj
